...
- *(server)* add SRT ingest

## [0.3.16](https://github.com/cetanu/rtmp-manager/compare/v0.3.15...v0.3.16) - 2026-09-18

### Other

- test and reuse release artifacts

## [0.3.15](https://github.com/cetanu/rtmp-manager/compare/v0.3.14...v0.3.15) - 2026-09-18

### Fixed

- *(ci)* specify repository for release upload

## [0.3.14](https://github.com/cetanu/rtmp-manager/compare/v0.3.13...v0.3.14) - 2026-09-18

### Fixed

- *(ci)* build release against target glibc
