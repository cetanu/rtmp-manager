...
| 303–304 | Disconnect grace, validated encoding profiles, target settings controls, and normalized encoded audio | Platform-specific reconnect/transcode validation |
